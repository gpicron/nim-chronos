  ...
  of AddressFamily.IPv6:
    if prefix <= 0:
      ...
      if prefix > 64:
        ...
        IpMask(
          family: AddressFamily.IPv6, mask6: [0xFFFF_FFFF_FFFF_FFFF'u64, mask.toBE()]
        )
      elif prefix == 64:
...
proc init*(t: typedesc[IpMask], netmask: TransportAddress): IpMask =
  ...
  case netmask.family
  of AddressFamily.IPv4:
    IpMask(family: AddressFamily.IPv4, mask4: uint32.fromBytes(netmask.address_v4))
  of AddressFamily.IPv6:
    IpMask(
      family: AddressFamily.IPv6,
      mask6: [
        uint64.fromBytes(netmask.address_v6.toOpenArray(0, 7)),
...
proc toIPv4*(address: TransportAddress): TransportAddress =
  ...
  of AddressFamily.IPv6:
    if isV4Mapped(address):
      ...
      TransportAddress(
        family: AddressFamily.IPv4, port: address.port, address_v4: data.toBytes()
      )
    else:
...
proc mask*(a: TransportAddress, m: IpMask): TransportAddress =
  ...
  if (a.family == AddressFamily.IPv4) and (m.family == AddressFamily.IPv6):
    if (m.mask6[0] == 0xFFFF_FFFF_FFFF_FFFF'u64) and
      ...
      TransportAddress(
        family: AddressFamily.IPv4, port: a.port, address_v4: (data and mask).toBytes()
      )
    else:
      TransportAddress(family: AddressFamily.None)
    ...
    TransportAddress(
      family: AddressFamily.IPv4, port: a.port, address_v4: (data and m.mask4).toBytes()
    )
...
proc subnetMask*(mask: IpMask): TransportAddress =
  ...
  case mask.family
  of AddressFamily.IPv4:
    TransportAddress(family: AddressFamily.IPv4, address_v4: mask.mask4.toBytes())
  of AddressFamily.IPv6:
    var address6: array[16, uint8]
...
proc broadcast*(net: IpNet): TransportAddress =
  ...
  of AddressFamily.IPv4:
    let
      ...
      mask = net.mask.mask4
    TransportAddress(
      family: AddressFamily.IPv4, address_v4: (host or (not (mask))).toBytes()
    )
  of AddressFamily.IPv6:
    var address6: array[16, uint8]
    let
...
proc `and`*(address1, address2: TransportAddress): TransportAddress =
  ...
  of AddressFamily.IPv4:
    ...
    TransportAddress(
      family: AddressFamily.IPv4, address_v4: (data1 and data2).toBytes()
    )
  of AddressFamily.IPv6:
    var address6: array[16, uint8]
    let
...
proc `or`*(address1, address2: TransportAddress): TransportAddress =
  ...
  of AddressFamily.IPv4:
    let
      data1 = uint32.fromBytes(address1.address_v4)
      data2 = uint32.fromBytes(address2.address_v4)
    TransportAddress(family: AddressFamily.IPv4, address_v4: (data1 or data2).toBytes())
  of AddressFamily.IPv6:
    var address6: array[16, uint8]
    let
      data1 = uint64.fromBytes(address1.address_v6.toOpenArray(0, 7))
